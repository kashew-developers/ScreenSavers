...
public class StraightLinesFragment extends Fragment {
    ...
    private int drawSpeed, screenHeight, screenWidth, linesDrawn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_straight_lines, container, false);
    ...
    private void drawLine(){
        ...
        int x = random.nextInt(screenWidth), y = random.nextInt(screenHeight);
        ...
        drawingCanvas.drawLine(0, y, screenWidth, y, drawingPaint);  // Horizontal Line
        drawingCanvas.drawLine(x, 0, x, screenHeight, drawingPaint);  // Vertical Line
        linesDrawn++;
