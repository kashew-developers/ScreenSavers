...
public class RandomLinesFragment extends Fragment {
    ...
    private int screenHeight, screenWidth, linesDrawn, drawSpeed;
    private boolean controlsVisible;

    private Context context;

    public RandomLinesFragment() { }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_random_lines, container, false);
